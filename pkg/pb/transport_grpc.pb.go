...
func (c *transportClient) Connect(ctx context.Context, opts ...grpc.CallOption) (Transport_ConnectClient, error) {
	stream, err := c.cc.NewStream(ctx, &Transport_ServiceDesc.Streams[0], "/pb.Transport/Connect", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *transportConnectClient) Send(m *Envelope) error {
	return x.ClientStream.SendMsg(m)
}

func (x *transportConnectClient) Recv() (*Envelope, error) {
	m := new(Envelope)
...
func (x *transportConnectServer) Send(m *Envelope) error {
	return x.ServerStream.SendMsg(m)
}

func (x *transportConnectServer) Recv() (*Envelope, error) {
	m := new(Envelope)
