...
const (
	...
	TemplateFindRecentTasks  = `SELECT uid, tenant_id, handler, config, schedule_strategy, priority, progress, status, created_at, updated_at FROM task %v ORDER BY created_at ASC LIMIT 500`
